...
static int pipefifo, returnval;
static char buffer[2];

void setup()
{
	cout << "Configuring pipe..." << endl;
	...
	cout << "Done configuring pipe" << endl;
}
